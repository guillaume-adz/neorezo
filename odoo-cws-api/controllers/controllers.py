...
class CwsAPI(http.Controller):
    ...
    @http.route("/cws_gql", auth='user', methods=["POST"], csrf=False, save_session=False)
    def cws_gql(self):
    ...
    @http.route('/cws_pdf/<int:rec_id>', auth='user', methods=["POST"], csrf=False, save_session=False)
